...
namespace CGL::Graphics
{
    ...
    void D3D11RendererImpl::CreateDevice()
    {
        ...
        if (!m_device)
        {
            ...
            DXCall(hr = ::D3D11CreateDevice(nullptr, D3D_DRIVER_TYPE_HARDWARE, nullptr, flags, nullptr, 0,
    ...
    void D3D11RendererImpl::ResizeSwapchain(u32 width, u32 height)
    {
        ...
        if (hr == DXGI_ERROR_DEVICE_REMOVED || hr == DXGI_ERROR_DEVICE_RESET)
        {
            ...
            std::string err =
                (hr == DXGI_ERROR_DEVICE_REMOVED) ? "The device was removed" : "Error during device reset";
