...
bool Renderer::CompileVertexShader(const ShaderSource &source,
...
bool Renderer::CompilePixelShader(const ShaderSource &source,
...
bool Renderer::CompileMaterial(Material *material) {
  ...
  if (bool vsResult = CompileVertexShader(material->m_vs->Source,
                                          &material->m_vs->Shader)) {
    result &= vsResult;
  ...
  if (bool psResult =
          CompilePixelShader(material->m_ps->Source, &material->m_ps->Shader)) {
    result &= psResult;
