...
#if defined(CGL_RHI_DX11) + defined(CGL_RHI_DX12) + defined(CGL_RHI_OPENGL) + defined(CGL_RHI_VULKAN) + \
        defined(CGL_RHI_METAL) !=                                                                       \
    1
    #error \
        "Illegal to build for multiple API's. Exactly one of CGL_RHI_DX11, CGL_RHI_DX12, CGL_RHI_OPENGL, CGL_RHI_VULKAN or CGL_RHI_METAL must be defined"
#endif
