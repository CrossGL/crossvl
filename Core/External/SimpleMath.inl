//-------------------------------------------------------------------------------------
// SimpleMath.inl -- Simplified C++ Math wrapper for DirectrectXMath
//
...
inline Vector2 Rectangle::Center() const noexcept {
  return Vector2(float(x) + (float(width) / 2.f),
...
inline Rectangle Rectangle::Intersect(const Rectangle &ra,
...
#endif
inline Rectangle Rectangle::Union(const Rectangle &ra,
                                  const Rectangle &rb) noexcept {
  const long righta = ra.x + ra.width;
  const long rightb = rb.x + rb.width;
...
inline float Vector2::DistanceSquared(const Vector2 &v1,
...
inline Vector2 Vector2::Lerp(const Vector2 &v1, const Vector2 &v2,
                             float t) noexcept {
  using namespace DirectX;
  const XMVECTOR x1 = XMLoadFloat2(&v1);
  const XMVECTOR x2 = XMLoadFloat2(&v2);
...
inline Vector2 Vector2::Hermite(const Vector2 &v1, const Vector2 &t1,
                                const Vector2 &v2, const Vector2 &t2,
                                float t) noexcept {
  using namespace DirectX;
  const XMVECTOR x1 = XMLoadFloat2(&v1);
  const XMVECTOR x2 = XMLoadFloat2(&t1);
...
inline Vector2 Vector2::Reflect(const Vector2 &ivec,
...
inline Vector2 Vector2::Transform(const Vector2 &v,
...
inline Vector2 Vector2::TransformNormal(const Vector2 &v,
...
inline float Vector3::DistanceSquared(const Vector3 &v1,
...
inline Vector3 Vector3::Lerp(const Vector3 &v1, const Vector3 &v2,
                             float t) noexcept {
  using namespace DirectX;
  const XMVECTOR x1 = XMLoadFloat3(&v1);
  const XMVECTOR x2 = XMLoadFloat3(&v2);
...
inline Vector3 Vector3::Hermite(const Vector3 &v1, const Vector3 &t1,
                                const Vector3 &v2, const Vector3 &t2,
                                float t) noexcept {
  using namespace DirectX;
  const XMVECTOR x1 = XMLoadFloat3(&v1);
  const XMVECTOR x2 = XMLoadFloat3(&t1);
...
inline Vector3 Vector3::Reflect(const Vector3 &ivec,
...
inline Vector3 Vector3::Transform(const Vector3 &v,
                                  const Quaternion &quat) noexcept {
  using namespace DirectX;
  const XMVECTOR v1 = XMLoadFloat3(&v);
  const XMVECTOR q = XMLoadFloat4(&quat);
...
inline Vector3 Vector3::TransformNormal(const Vector3 &v,
                                        const Matrix &m) noexcept {
  using namespace DirectX;
  const XMVECTOR v1 = XMLoadFloat3(&v);
  const XMMATRIX M = XMLoadFloat4x4(&m);
...
inline Vector4 Vector4::Cross(const Vector4 &v1,
                              const Vector4 &v2) const noexcept {
  using namespace DirectX;
  const XMVECTOR x1 = XMLoadFloat4(this);
  const XMVECTOR x2 = XMLoadFloat4(&v1);
  const XMVECTOR x3 = XMLoadFloat4(&v2);
...
inline float Vector4::DistanceSquared(const Vector4 &v1,
...
inline Vector4 Vector4::Lerp(const Vector4 &v1, const Vector4 &v2,
                             float t) noexcept {
  using namespace DirectX;
  const XMVECTOR x1 = XMLoadFloat4(&v1);
  const XMVECTOR x2 = XMLoadFloat4(&v2);
...
inline Vector4 Vector4::Hermite(const Vector4 &v1, const Vector4 &t1,
                                const Vector4 &v2, const Vector4 &t2,
                                float t) noexcept {
  using namespace DirectX;
  const XMVECTOR x1 = XMLoadFloat4(&v1);
  const XMVECTOR x2 = XMLoadFloat4(&t1);
...
inline Vector4 Vector4::Reflect(const Vector4 &ivec,
...
inline Vector4 Vector4::Transform(const Vector2 &v,
                                  const Quaternion &quat) noexcept {
  using namespace DirectX;
  const XMVECTOR v1 = XMLoadFloat2(&v);
  const XMVECTOR q = XMLoadFloat4(&quat);
...
inline Vector4 Vector4::Transform(const Vector3 &v,
                                  const Quaternion &quat) noexcept {
  using namespace DirectX;
  const XMVECTOR v1 = XMLoadFloat3(&v);
  const XMVECTOR q = XMLoadFloat4(&quat);
...
inline Vector4 Vector4::Transform(const Vector4 &v,
                                  const Quaternion &quat) noexcept {
  using namespace DirectX;
  const XMVECTOR v1 = XMLoadFloat4(&v);
  const XMVECTOR q = XMLoadFloat4(&quat);
...
inline Matrix Matrix::CreateFromAxisAngle(const Vector3 &axis,
...
inline Matrix Matrix::Lerp(const Matrix &M1, const Matrix &M2,
                           float t) noexcept {
  using namespace DirectX;
  XMVECTOR x1 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4 *>(&M1._11));
  XMVECTOR x2 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4 *>(&M1._21));
...
inline Matrix Matrix::Transform(const Matrix &M,
...
inline Plane Plane::Transform(const Plane &plane,
                              const Quaternion &rotation) noexcept {
  using namespace DirectX;
  const XMVECTOR p = XMLoadFloat4(&plane);
  const XMVECTOR q = XMLoadFloat4(&rotation);
...
inline void Quaternion::RotateTowards(const Quaternion &target,
                                      float maxAngle) noexcept {
...
inline Quaternion
Quaternion::CreateFromRotationMatrix(const Matrix &M) noexcept {
  using namespace DirectX;
  const XMMATRIX M0 = XMLoadFloat4x4(&M);
...
inline Quaternion Quaternion::FromToRotation(const Vector3 &fromDir,
...
inline Quaternion Quaternion::LookRotation(const Vector3 &forward,
                                           const Vector3 &up) noexcept {
  Quaternion result;
...
inline float Quaternion::Angle(const Quaternion &q1,
                               const Quaternion &q2) noexcept {
  using namespace DirectX;
  const XMVECTOR Q0 = XMLoadFloat4(&q1);
  const XMVECTOR Q1 = XMLoadFloat4(&q2);
...
inline Vector3 Color::ToVector3() const noexcept { return Vector3(x, y, z); }

inline Vector4 Color::ToVector4() const noexcept { return Vector4(x, y, z, w); }
...
inline void Color::Modulate(const Color &c1, const Color &c2,
...
inline bool Ray::Intersects(const BoundingBox &box,
                            _Out_ float &Dist) const noexcept {
...
inline bool Ray::Intersects(const Plane &plane,
                            _Out_ float &Dist) const noexcept {
  using namespace DirectX;
