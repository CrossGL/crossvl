...
#pragma once
    ...
    !(defined(_XBOX_ONE) && defined(_TITLE)) && !defined(_GAMING_XBOX)
#include <dxgi1_2.h>
#endif
...
struct Rectangle {
  ...
  operator Windows::Foundation::Rect() noexcept {
    return Windows::Foundation::Rect(float(x), float(y), float(width),
                                     float(height));
  }
#endif
#endif
...
struct Vector2 : public XMFLOAT2 {
  ...
  static void Min(const Vector2 &v1, const Vector2 &v2,
                  Vector2 &result) noexcept;
  static Vector2 Min(const Vector2 &v1, const Vector2 &v2) noexcept;

  static void Max(const Vector2 &v1, const Vector2 &v2,
                  Vector2 &result) noexcept;
  ...
  static void SmoothStep(const Vector2 &v1, const Vector2 &v2, float t,
                         Vector2 &result) noexcept;
  static Vector2 SmoothStep(const Vector2 &v1, const Vector2 &v2,
                            float t) noexcept;
  ...
  static void Transform(const Vector2 &v, const Matrix &m,
                        Vector2 &result) noexcept;
...
struct Vector3 : public XMFLOAT3 {
  ...
  static void Min(const Vector3 &v1, const Vector3 &v2,
                  Vector3 &result) noexcept;
  static Vector3 Min(const Vector3 &v1, const Vector3 &v2) noexcept;

  static void Max(const Vector3 &v1, const Vector3 &v2,
                  Vector3 &result) noexcept;
  ...
  static void SmoothStep(const Vector3 &v1, const Vector3 &v2, float t,
                         Vector3 &result) noexcept;
  static Vector3 SmoothStep(const Vector3 &v1, const Vector3 &v2,
                            float t) noexcept;
  ...
  static void Transform(const Vector3 &v, const Matrix &m,
                        Vector3 &result) noexcept;
...
struct Vector4 : public XMFLOAT4 {
  ...
  static void Min(const Vector4 &v1, const Vector4 &v2,
                  Vector4 &result) noexcept;
  static Vector4 Min(const Vector4 &v1, const Vector4 &v2) noexcept;

  static void Max(const Vector4 &v1, const Vector4 &v2,
                  Vector4 &result) noexcept;
  ...
  static void SmoothStep(const Vector4 &v1, const Vector4 &v2, float t,
                         Vector4 &result) noexcept;
  static Vector4 SmoothStep(const Vector4 &v1, const Vector4 &v2,
                            float t) noexcept;
  ...
  static void Transform(const Vector4 &v, const Matrix &m,
                        Vector4 &result) noexcept;
...
struct Matrix : public XMFLOAT4X4 {
  ...
  constexpr Matrix(float m00, float m01, float m02, float m03, float m10,
  ...
  // Static functions
  static Matrix
  CreateBillboard(const Vector3 &object, const Vector3 &cameraPosition,
  ...
  static Matrix CreateFromYawPitchRoll(float yaw, float pitch,
                                       float roll) noexcept;
...
struct Plane : public XMFLOAT4 {
  ...
  // Static functions
  static void Transform(const Plane &plane, const Matrix &M,
...
struct Quaternion : public XMFLOAT4 {
  ...
  void __cdecl RotateTowards(const Quaternion &target, float maxAngle,
  ...
  // Rotates about y-axis (yaw), then x-axis (pitch), then z-axis (roll)
  static Quaternion CreateFromYawPitchRoll(float yaw, float pitch,
                                           float roll) noexcept;
  ...
  static Quaternion Lerp(const Quaternion &q1, const Quaternion &q2,
                         float t) noexcept;
  ...
  static void __cdecl FromToRotation(const Vector3 &fromDir,
                                     const Vector3 &toDir,
                                     Quaternion &result) noexcept;
  static Quaternion FromToRotation(const Vector3 &fromDir,
                                   const Vector3 &toDir) noexcept;

  static void __cdecl LookRotation(const Vector3 &forward, const Vector3 &up,
                                   Quaternion &result) noexcept;
...
struct Color : public XMFLOAT4 {
  ...
  // Static functions
  static void Modulate(const Color &c1, const Color &c2,
...
public:
  ...
  constexpr Viewport(float ix, float iy, float iw, float ih, float iminz = 0.f,
  ...
  explicit Viewport(const RECT &rct) noexcept
      : x(float(rct.left)), y(float(rct.top)),
        width(float(rct.right - rct.left)), height(float(rct.bottom - rct.top)),
