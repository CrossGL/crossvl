...
int main() {
  ...
  SDL_Window *window =
      SDL_CreateWindow("Visualizer", SDL_WINDOWPOS_CENTERED,
  ...
  while (state) {
    ...
    MTL::RenderCommandEncoder *cmdEncoder =
        cmdBuffer->renderCommandEncoder(rpDescriptor);
    ...
    cmdEncoder->drawPrimitives(MTL::PrimitiveType::PrimitiveTypeTriangle,
