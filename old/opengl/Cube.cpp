...
Cube::Cube()
    : vboID(0), iboID(0), position(0.0f), scale(1.0f), rotationAngle(0.0f), axis(1.0f), model(glm::mat4(1.0f))
...
void Cube::update(float deltaTime)
{
    ...
    model = glm::translate(glm::mat4(0.1f), position) * glm::scale(glm::mat4(0.1f), scale) *
...
void Cube::render(GLuint gProgramID)
{
    ...
    glVertexAttribPointer(vertexColorLocation, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(GLfloat),
